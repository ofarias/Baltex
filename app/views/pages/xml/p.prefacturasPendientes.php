...
*/
    ...
    function facturarCaja(idcaja, docf, val, uso, tpago, mpago, rel){
        if(val >0){
            alert('Faltan ' + val + ' Productos sin registro fiscal, los puede consultar en la prefactura, gracias');
                ...
                $.ajax({
                    ...
                    method:'POST',
                    dataType:'json',
                    data:{facturar:idcaja, uso:uso, tpago:tpago, mpago:mpago, rel:rel},
                    success:function(data){
                        if(data.status == 'ok'){
            ...
            '</form>',
                ...
                action: function () {
                    ...
                    if(uso=='a'){
                      ...
                      facturarCaja(idcaja, docf, val, uso, tpago, mpago, rel);
                    }
                   }
            },
            cancelar: function () {
